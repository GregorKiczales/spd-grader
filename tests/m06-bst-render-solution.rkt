...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname m06-bst-render-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
(require 2htdp/image)
(require spd/tags)
