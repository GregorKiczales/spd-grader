...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname pset-02-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #t)))
...
;; preference. Design this function, call it preference?
;;
