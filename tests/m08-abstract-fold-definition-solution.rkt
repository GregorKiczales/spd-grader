...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname m08-abstract-fold-definition-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
