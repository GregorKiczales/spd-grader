...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname m11-maze-4-way-shortest-path-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
(require spd/tags)
(@assignment lectures/m11-maze-4-way-shortest-path)
(@problem 1)
