...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname m05-raining-eggs-v4) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
(require 2htdp/image)
...
(check-expect (next-eggs (cons (make-egg 10 20 30) (cons (make-egg 11 21 31) empty)))
