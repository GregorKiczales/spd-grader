...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname m06-bst-lookup-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
(require 2htdp/image)
(require spd/tags)

;; bst-starter.rkt
(@assignment lectures/m06-bst-lookup)
(define TEXT-SIZE 60)
