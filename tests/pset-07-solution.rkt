...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname pset-07-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
...
(check-expect (courses-w-credits C210 4) (list C210 C213 C221 C310 C319))
...
(@template Course ListOfCourse try-catch encapsulated)
