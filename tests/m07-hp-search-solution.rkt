...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname m07-hp-search-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
(require spd/tags)
...
(@template Wizard ListOfWizard encapsulated try-catch)
