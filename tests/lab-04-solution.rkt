...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname lab-04-editor) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
(require spd/tags)
(require 2htdp/image)
...
(check-expect (backspace (make-editor "abc" "")) (make-editor "ab" ""))
(check-expect (backspace (make-editor "" "abc")) (make-editor "" "abc"))
...
(check-expect (insert (make-editor "" "") "x") (make-editor "x" ""))
(check-expect (insert (make-editor "ab" "cde") " ") (make-editor "ab " "cde"))
(check-expect (insert (make-editor "" "opqr") "n") (make-editor "n" "opqr"))
...
(check-expect (string-butfirst "cat") "at")
